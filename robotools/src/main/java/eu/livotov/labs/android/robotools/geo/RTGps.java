...
public class RTGps implements LocationListener
{
    ...
    public boolean enable(boolean canUseCachedDataOnly)
    {
        ...
        try
        {
            ...
            final Location lastProviderLocation = lm.getLastKnownLocation(LocationManager.PASSIVE_PROVIDER);
            ...
            if (!nearSameTime)
            {
                ...
                try
                {
                    lm.requestLocationUpdates(LocationManager.PASSIVE_PROVIDER, 20000, 500, this);
                ...
                try
                {
                    lm.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 5000, 500, this);
